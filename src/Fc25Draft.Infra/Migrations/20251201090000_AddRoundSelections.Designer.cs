...
namespace Fc25Draft.Infra.Migrations
{
    ...
    [Migration("20251201090000_AddRoundSelections")]
    partial class AddRoundSelections : Migration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity<Round>(b =>
                {
                    b.Property(r => r.RoundId)
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property(r => r.CompetitionId)
                        .HasColumnType("uuid");

                    b.Property(r => r.IsCompleted)
                        .HasColumnType("boolean");
                    ...
                    b.Property(r => r.PlayedAtUtc)
                        .HasColumnType("timestamp with time zone");

                    b.HasKey(r => r.RoundId);

                    b.HasIndex(r => r.CompetitionId);

                    b.HasIndex(r => new { r.CompetitionId, r.Name })
                        .IsUnique();

                    b.ToTable("Rounds");
                });

            modelBuilder.Entity<RoundSelection>(b =>
                {
                    b.Property(rs => rs.RoundSelectionId)
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property(rs => rs.CreatedAtUtc)
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("CreatedAt");

                    b.Property(rs => rs.RoundId)
                        .HasColumnType("uuid");

                    b.HasKey(rs => rs.RoundSelectionId);

                    b.HasIndex(rs => rs.RoundId)
                        .IsUnique();

                    b.ToTable("RoundSelections");
                });

            modelBuilder.Entity<RoundSelectionPlayer>(b =>
                {
                    b.Property(rsp => rsp.RoundSelectionId)
                        .HasColumnType("uuid");

                    b.Property(rsp => rsp.PlayerId)
                        .HasColumnType("integer");

                    b.Property(rsp => rsp.AddedAtUtc)
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("AddedAt");

                    b.HasKey(rsp => new { rsp.RoundSelectionId, rsp.PlayerId });

                    b.HasIndex(rsp => rsp.PlayerId);
            ...
            modelBuilder.Entity<SeasonScheduleItem>(b =>
                {
                    b.Property(ss => ss.SeasonScheduleItemId)
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property(ss => ss.Order)
                        .HasColumnType("integer");

                    b.Property(ss => ss.RoundId)
                        .HasColumnType("uuid");

                    b.Property(ss => ss.SeasonId)
                        .HasColumnType("uuid");

                    b.HasKey(ss => ss.SeasonScheduleItemId);

                    b.HasIndex(ss => ss.RoundId);

                    b.HasIndex(ss => new { ss.SeasonId, ss.Order })
                        .IsUnique();
            ...
            modelBuilder.Entity<Round>(b =>
                {
                    b.HasOne(r => r.Competition)
                        .WithMany(c => c.Rounds)
                        .HasForeignKey(r => r.CompetitionId)
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation(r => r.Competition);
                    b.Navigation(r => r.Selection);
                });
            ...
            modelBuilder.Entity<RoundSelection>(b =>
                {
                    b.HasOne(rs => rs.Round)
                        ...
                        .HasForeignKey<RoundSelection>(rs => rs.RoundId)
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation(rs => rs.Players);

                    b.Navigation(rs => rs.Round);
                });

            modelBuilder.Entity<RoundSelectionPlayer>(b =>
                {
                    b.HasOne(rsp => rsp.Player)
                        .WithMany(p => p.RoundSelections)
                        .HasForeignKey(rsp => rsp.PlayerId)
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne(rsp => rsp.RoundSelection)
                        .WithMany(rs => rs.Players)
                        .HasForeignKey(rsp => rsp.RoundSelectionId)
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation(rsp => rsp.Player);

                    b.Navigation(rsp => rsp.RoundSelection);
                });

            modelBuilder.Entity<SeasonScheduleItem>(b =>
                {
                    b.HasOne(ss => ss.Round)
                        .WithMany()
                        .HasForeignKey(ss => ss.RoundId)
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne(ss => ss.Season)
                        .WithMany(s => s.Schedule)
                        .HasForeignKey(ss => ss.SeasonId)
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation(ss => ss.Round);

                    b.Navigation(ss => ss.Season);
                });
